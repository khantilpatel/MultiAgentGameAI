...
////--------------------------------------------------------------------------------------
//
//	int WINAPI hello1(HINSTANCE hInstance, HINSTANCE hPrevInstance, PSTR pScmdline, int iCmdshow)
//{
//	RedirectIOToConsole();
...
//    if ( FAILED( CreateComputeShader( L"BasicCompute11_new.hlsl", "CSMain", g_pDevice, &g_pCS ) ) )
//        return 1;
//    printf( "done\n" );
//
