...
////////////////////////////////////////////////////////////////////////////////
#ifndef _RAINPARTICLESYSTEMSHADERCLASS_H_
#define _RAINPARTICLESYSTEMSHADERCLASS_H_
...
private:
	...
	bool SetShaderParameters_StreamOut(ID3D11DeviceContext*, float , float , XMFLOAT3, D3DXMATRIX* );
...
private:
	...
	int m_vertexCount;
	static const int m_MaxParticles = 10000;
	bool flag_FirstRun;
};
